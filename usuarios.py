...
def upload_s3(file,paste,bucket,df):
    ...
    s3 = boto3.client("s3",aws_access_key_id="AKIAUYNBXWWU2IA5QJNC", aws_secret_access_key="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")
    csv_buf = StringIO()
...
MEMBROS_FC_antes = read_csv_s3("RAW_MEMBROS_ANTES.csv","client","ffdatabucket")
...
# %%
upload_s3("RAW_MEMBROS_ANTES.csv","client","ffdatabucket",MEMBROS_FC_DEPOIS)
